...
/*                                                +#+#+#+#+#+   +#+           */
/*   Created: 2023/12/05 21:54:17 by octoross          #+#    #+#             */
/*   Updated: 2023/12/05 21:54:17 by octoross         ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
t_gnl	*ft_read_line(int fd)
{
	...
	line = (t_gnl *)malloc(sizeof(t_gnl));
	if (!line)
		return (NULL);
...
int	ft_read(t_gnl **leftovers, int fd)
{
	t_gnl	*next;
